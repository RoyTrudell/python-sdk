...
class Consent(object):
    ...
    def __init__(self, data_access_frequency=None, title_body=None, consent_id=None, provider_id=None, consent_status=None, provider_account_id=None, scope=None, title=None, expiration_date=None):  # noqa: E501
