...
class AddedProviderAccount(object):
    ...
    def __init__(self, last_updated=None, aggregation_source=None, provider_id=None, request_id=None, is_manual=None, id=None, dataset=None, status=None):  # noqa: E501
