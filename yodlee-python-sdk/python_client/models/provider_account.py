...
class ProviderAccount(object):
    ...
    def __init__(self, last_updated=None, consent_id=None, preferences=None, created_date=None, aggregation_source=None, provider_id=None, request_id=None, is_manual=None, id=None, dataset=None, status=None):  # noqa: E501
