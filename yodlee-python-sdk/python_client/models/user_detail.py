...
class UserDetail(object):
    ...
    def __init__(self, preferences=None, address=None, login_name=None, name=None, id=None, role_type=None, email=None, segment_name=None):  # noqa: E501
    ...
    def address(self):
        ...
        The address of the user.<br><br><b>Endpoints</b>:<ul><li>GET user</li></ul>  # noqa: E501
