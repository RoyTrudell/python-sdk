...
class StatementsApi(object):
    ...
    def get_statements(self, **kwargs):  # noqa: E501
        ...
        The statements service is used to get the list of statement related information. <br>By default, all the latest statements of active and to be closed accounts are retrieved for the user. <br>Certain sites do not have both a statement date and a due date. When a fromDate is passed as an <br>input, all the statements that have the due date on or after the passed date are retrieved. <br>For sites that do not have the due date, statements that have the statement date <br>on or after the passed date are retrieved. <br>The default value of \"isLatest\" is true. To retrieve historical statements isLatest needs to be set to false.<br>  # noqa: E501
        ...
        :param str container: creditCard/loan/bill/insurance
        :param str from_date: from date for statement retrieval (YYYY-MM-DD)
        :param str is_latest: isLatest (true/false)
        :param str status: ACTIVE,TO_BE_CLOSED,CLOSED
    ...
    def get_statements_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['account_id', 'container', 'from_date', 'is_latest', 'status']  # noqa: E501
        ...
        if 'is_latest' in params:
            query_params.append(('isLatest', params['is_latest']))  # noqa: E501
        if 'status' in params:
        ...
        return self.api_client.call_api(
            ...
            response_type='StatementResponse',  # noqa: E501
